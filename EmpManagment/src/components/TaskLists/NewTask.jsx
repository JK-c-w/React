...
function NewTask({task}) {
  return (
    <>
         <div className="w-[full] min-h-[150px] mb-[10px] bg-[#191973] py-[8px] px-[15px] rounded mt-[-5px]">
         ...
         <button className="px-[3px] bg-[green] font-semibold rounded">Accept</button>
         <button className="px-[3px] bg-[red] font-semibold rounded">Reject</button>
         </div>
         </div>        
    </div>

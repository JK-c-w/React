...
function Page2() {
  ...
  return (
    <div id="section2" className=' flex  flex-col items-center w-[100%]  bg-[white] h-auto'> 
    <div className='rotateX'>
       <span  className=' text-[black] font-black leading-none font-[Font1] text-[500px] uppercase'>impactful</span>
    </div>  
    <div className='rotateX'>
    <span  className=' text-[black]  font-black leading-[300px] font-[Font1] text-[500px] uppercase'>design</span><br/>
    </div>   
    <div className='rotateX'>
    <span  className='text-[black] font-black leading-[450px] font-[Font1] text-[500px] uppercase'>is the</span><br/>
    </div>  
    <div className='rotateX'>
    <span  className=' text-[black] font-black  leading-[350px] font-[Font1] text-[500px] uppercase'>design</span><br/>
    </div>  
    <div className='rotateX'>
    <span  className=' text-[black] font-black leading-[450px] font-[Font1] text-[500px] uppercase'>that</span><br/>
    </div>  
    <div className='rotateX '>
    <span  className=' text-[black] font-black  leading-[300px] font-[Font1] text-[500px] uppercase'>Works!</span><br/>
    </div>  
    <div className='flex items-center justify-center pt-[20px]'>
    <svg preserveAspectRatio="xMidYMid meet" data-bbox="4 0 2028.339 83" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2037 91" height="35" width="900" data-type="ugc" role="img" aria-label="Tesla, Figma, Wix Studio, Google+, BeHance monochrome Logo Design by Anzo Studio ">
    <g>
